...
<form id="login_form" class="loginLay" method="post" action="l_handler1.php">
<div class="row">
<div id="author"><br/><br/><br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button><a>CUSTOMER</a></button><button><a>MEMBER</a></button>
</div>
...
<div class="row">
<div class="rowl"><label for="elogin">EMAIL ID</label></div><div class="rowr"><input type="text" name="u_eml" id="elogin" placeholder="Enter valid email-address"/><i class="erLbl">Please enter valid email address</i>
</div></div>
<div class="row"><div class="rowl"><label for="epass">PASSWORD</label></div><div class="rowr"><input type="password" id="epass" name="u_pass"></div>
</div>
<div class="row_forget"><a href="" target="_blank">Forgot your password?</a></div>
<div class="row">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button value="login">LOGIN</button></div>
<div class="row">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>"Not as a member yet?"</span><a href="flora_reg.php">Register now</a></div>
